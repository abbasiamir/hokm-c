Public Class Main
    ...
    Private Sub Main_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim Image1 As Image = New Bitmap(path + "02اسپیک.bmp")
        For index = 0 To Me.Controls.Count - 1
            Dim ctrl As Control = Me.Controls(index)
            If (ctrl.ToString().IndexOf("PictureBox") <> -1) Then
                ctrl.Width = Image1.Width
                ctrl.Height = Image1.Height
